...
batch
  ...
  .post('', zValidator('json', zodBatchEvent), async c => {
              ...
              match(event)
                ...
                .with(
                  ...
                  async playMove => {
                    ...
                    await awaitResponse(
                      gameStub.fetch(
                        `${new URL(c.req.url).origin}/${playMove.game_id}/play_move`,
                        {
                          method: 'POST',
                ...
                .with(
                  ...
                  async resignGame => {
                    ...
                    await awaitResponse(
                      gameStub.fetch(
                        `${new URL(c.req.url).origin}/${resignGame.game_id}/resign_game`,
                        {
                          method: 'POST',
                ...
                .with(
                  ...
                  async cancelGame => {
                    ...
                    await awaitResponse(
                      gameStub.fetch(
                        `${new URL(c.req.url).origin}/${cancelGame.game_id}/cancel_game`,
                        {
                          method: 'POST',
