...
export async function registerPushNotifications(accountId: string): Promise<boolean> {
...
export async function unregisterPushNotifications(accountId: string): Promise<void> {
